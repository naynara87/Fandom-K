      ...
      <main>
        <section className="section sec01">
          <div className="section-wrap">
            ...
            <Link to="/list" className="btn-main" onClick={clearLocalStorage}>
              지금 시작하기
            </Link>
          </div>
        </section>
        <section className="section sec02">
          <div className="section-wrap">
            <p className="section-sub-title">후원하기</p>
        ...
        <section className="section sec03">
          <div className="section-wrap">
            <p className="section-sub-title">이달의 아티스트</p>
            <h2 className="section-title">
              내 아티스트에게 1등의
              <br />
              영예를 선물하세요
        ...
        <section className="section sec04">
          <div className="section-wrap">
            <p className="section-sub-title">나만의 아티스트</p>
            <h2 className="section-title">
              좋아하는 아티스트들의
              <br />
              소식을 모아보세요
